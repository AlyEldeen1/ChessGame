...
public abstract class ChessGame {
    ...
    public Stack<ChessBoard> boardStates = new Stack<>();
    ...
    {
//        System.out.println("setboard setter");
        this.board= board;
...
//        System.out.println(boardStates.size());
   ...
   public void undoMove() {
        ...
        if (!boardStates.isEmpty()) {
            ChessBoard previousBoard = boardStates.pop();
//            System.out.println("popped");
            setBoard(previousBoard);
            updateGameStatus();  // Make sure to update the game status after setting the board
        }  
